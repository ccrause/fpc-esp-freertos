...
type
  Padc_channel_t = ^Tadc_channel;
  Tadc_channel = (ADC_CHANNEL_0 = 0, ADC_CHANNEL_1, ADC_CHANNEL_2,
    ADC_CHANNEL_3, ADC_CHANNEL_4, ADC_CHANNEL_5,
    ADC_CHANNEL_6, ADC_CHANNEL_7, ADC_CHANNEL_8,
    ADC_CHANNEL_9, ADC_CHANNEL_MAX);

  Padc_atten_t = ^Tadc_atten;
  Tadc_atten = (ADC_ATTEN_DB_0 = 0, ADC_ATTEN_DB_2_5 = 1,
  ...
  Padc_bits_width_t = ^Tadc_bits_width;
  Tadc_bits_width = (ADC_WIDTH_BIT_9 = 0, ADC_WIDTH_BIT_10 = 1,
