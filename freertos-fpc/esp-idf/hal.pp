...
procedure xthal_save_extra(base: pointer); external;
procedure xthal_restore_extra(base: pointer); external;
procedure xthal_save_cpregs(base: pointer; para2: int32); external;
procedure xthal_restore_cpregs(base: pointer; para2: int32); external;
procedure xthal_save_cp0(base: pointer); external;
procedure xthal_save_cp1(base: pointer); external;
procedure xthal_save_cp2(base: pointer); external;
procedure xthal_save_cp3(base: pointer); external;
procedure xthal_save_cp4(base: pointer); external;
procedure xthal_save_cp5(base: pointer); external;
procedure xthal_save_cp6(base: pointer); external;
procedure xthal_save_cp7(base: pointer); external;
procedure xthal_restore_cp0(base: pointer); external;
procedure xthal_restore_cp1(base: pointer); external;
procedure xthal_restore_cp2(base: pointer); external;
procedure xthal_restore_cp3(base: pointer); external;
procedure xthal_restore_cp4(base: pointer); external;
procedure xthal_restore_cp5(base: pointer); external;
procedure xthal_restore_cp6(base: pointer); external;
procedure xthal_restore_cp7(base: pointer); external;
procedure xthal_init_mem_extra(para1: pointer); external;
procedure xthal_init_mem_cp(para1: pointer; para2: int32); external;
procedure xthal_icache_region_invalidate(addr: pointer; size: uint32); external;
procedure xthal_dcache_region_invalidate(addr: pointer; size: uint32); external;
procedure xthal_dcache_region_writeback(addr: pointer; size: uint32); external;
procedure xthal_dcache_region_writeback_inv(addr: pointer; size: uint32);
  external;
{$ifndef XTHAL_USE_CACHE_MACROS}
procedure xthal_icache_line_invalidate(addr: pointer); external;
procedure xthal_dcache_line_invalidate(addr: pointer); external;
procedure xthal_dcache_line_writeback(addr: pointer); external;
procedure xthal_dcache_line_writeback_inv(addr: pointer); external;
procedure xthal_icache_sync; external;
procedure xthal_dcache_sync; external;
{$endif}
function xthal_icache_get_ways: uint32; external;
procedure xthal_icache_set_ways(ways: uint32); external;
function xthal_dcache_get_ways: uint32; external;
procedure xthal_dcache_set_ways(ways: uint32); external;
procedure xthal_cache_coherence_on; external;
procedure xthal_cache_coherence_off; external;
procedure xthal_cache_coherence_optin; external;
procedure xthal_cache_coherence_optout; external;
...
function xthal_get_cache_prefetch: int32; external;
function xthal_set_cache_prefetch(para1: int32): int32; external;
function xthal_set_cache_prefetch_long(para1: uint64): int32; external;
function xthal_set_soft_break(addr: pointer): uint32; external;
procedure xthal_remove_soft_break(addr: pointer; para2: uint32); external;
function xthal_disassemble(instr_buf: PByte; tgt_addr: pointer;
  buffer: PChar; buflen: uint32; options: uint32): int32; external;
function xthal_disassemble_size(instr_buf: PByte): int32; external;
function xthal_memcpy(dst: pointer; src: pointer; len: uint32): pointer; external;
function xthal_bcopy(src: pointer; dst: pointer; len: uint32): pointer; external;
function xthal_compare_and_set(addr: PInt32; test_val: int32;
  compare_val: int32): int32; external;
procedure xthal_clear_regcached_code; external;
...
procedure xthal_window_spill; external;
procedure xthal_validate_cp(para1: int32); external;
procedure xthal_invalidate_cp(para1: int32); external;
procedure xthal_set_cpenable(para1: uint32); external;
function xthal_get_cpenable: uint32; external;
function xthal_get_intenable: uint32; external;
procedure xthal_set_intenable(para1: uint32); external;
function xthal_get_interrupt: uint32; external;
procedure xthal_set_intset(para1: uint32); external;
procedure xthal_set_intclear(para1: uint32); external;
function xthal_get_ccount: uint32; external;
procedure xthal_set_ccompare(para1: int32; para2: uint32); external;
function xthal_get_ccompare(para1: int32): uint32; external;
function xthal_get_prid: uint32; external;
function xthal_vpri_to_intlevel(vpri: uint32): uint32; external;
function xthal_intlevel_to_vpri(intlevel: uint32): uint32; external;
function xthal_int_enable(para1: uint32): uint32; external;
function xthal_int_disable(para1: uint32): uint32; external;
function xthal_set_int_vpri(intnum: int32; vpri: int32): int32; external;
function xthal_get_int_vpri(intnum: int32): int32; external;
procedure xthal_set_vpri_locklevel(intlevel: uint32); external;
function xthal_get_vpri_locklevel: uint32; external;
function xthal_set_vpri(vpri: uint32): uint32; external;
function xthal_get_vpri: uint32; external;
function xthal_set_vpri_intlevel(intlevel: uint32): uint32; external;
function xthal_set_vpri_lock: uint32; external;
function xthal_tram_pending_to_service: uint32; external;
procedure xthal_tram_done(serviced_mask: uint32); external;
function xthal_tram_set_sync(intnum: int32; sync: int32): int32; external;
function xthal_set_tram_trigger_func(trigger_fn: PXtHalVoidFunc): PXtHalVoidFunc;
  external;
function xthal_get_cacheattr: uint32; external;
function xthal_get_icacheattr: uint32; external;
function xthal_get_dcacheattr: uint32; external;
procedure xthal_set_cacheattr(para1: uint32); external;
procedure xthal_set_icacheattr(para1: uint32); external;
procedure xthal_set_dcacheattr(para1: uint32); external;
function xthal_set_region_attribute(addr: pointer; size: uint32;
  cattr: uint32; flags: uint32): int32; external;
procedure xthal_icache_enable; external;
procedure xthal_dcache_enable; external;
procedure xthal_icache_disable; external;
procedure xthal_dcache_disable; external;
procedure xthal_icache_all_invalidate; external;
procedure xthal_dcache_all_invalidate; external;
procedure xthal_dcache_all_writeback; external;
procedure xthal_dcache_all_writeback_inv; external;
procedure xthal_icache_all_unlock; external;
procedure xthal_dcache_all_unlock; external;
procedure xthal_icache_region_lock(addr: pointer; size: uint32); external;
procedure xthal_dcache_region_lock(addr: pointer; size: uint32); external;
procedure xthal_icache_region_unlock(addr: pointer; size: uint32); external;
procedure xthal_dcache_region_unlock(addr: pointer; size: uint32); external;
procedure xthal_icache_hugerange_invalidate(addr: pointer; size: uint32);
  external;
procedure xthal_icache_hugerange_unlock(addr: pointer; size: uint32); external;
procedure xthal_dcache_hugerange_invalidate(addr: pointer; size: uint32);
  external;
procedure xthal_dcache_hugerange_unlock(addr: pointer; size: uint32); external;
procedure xthal_dcache_hugerange_writeback(addr: pointer; size: uint32); external;
procedure xthal_dcache_hugerange_writeback_inv(addr: pointer;
  size: uint32); external;
{$ifndef XTHAL_USE_CACHE_MACROS}
procedure xthal_icache_line_lock(addr: pointer); external;
procedure xthal_dcache_line_lock(addr: pointer); external;
procedure xthal_icache_line_unlock(addr: pointer); external;
procedure xthal_dcache_line_unlock(addr: pointer); external;
{$endif}
procedure xthal_memep_inject_error(addr: pointer; size: int32; flags: int32); external;
function xthal_static_v2p(vaddr: uint32; paddrp: PUint32): int32; external;
function xthal_static_p2v(paddr: uint32; vaddrp: PUint32;
  cached: uint32): int32; external;
function xthal_set_region_translation(vaddr: pointer; paddr: pointer;
  size: uint32; cache_atr: uint32; flags: uint32): int32; external;
function xthal_v2p(para1: pointer; para2: Ppointer; para3: PUint32;
  para4: PUint32): int32; external;
function xthal_invalidate_region(addr: pointer): int32; external;
function xthal_set_region_translation_raw(vaddr: pointer; paddr: pointer;
  cattr: uint32): int32; external;
...
function xthal_is_kernel_readable(accessRights: uint32): int32; external;
function xthal_is_kernel_writeable(accessRights: uint32): int32; external;
function xthal_is_kernel_executable(accessRights: uint32): int32; external;
function xthal_is_user_readable(accessRights: uint32): int32; external;
function xthal_is_user_writeable(accessRights: uint32): int32; external;
function xthal_is_user_executable(accessRights: uint32): int32; external;
function xthal_encode_memory_type(x: uint32): int32; external;
function xthal_is_cacheable(memoryType: uint32): int32; external;
function xthal_is_writeback(memoryType: uint32): int32; external;
function xthal_is_device(memoryType: uint32): int32; external;
function xthal_read_map(entries: Pxthal_MPU_entry): int32; external;
procedure xthal_write_map(entries: Pxthal_MPU_entry; n: uint32); external;
function xthal_check_map(entries: Pxthal_MPU_entry; n: uint32): int32; external;
function xthal_get_entry_for_address(vaddr: pointer;
  infgmap: Pint32): Txthal_MPU_entry; external;
...
function xthal_mpu_set_region_attribute(vaddr: pointer; size: uint32;
  accessRights: int32; memoryType: int32; flags: uint32): int32; external;
...
function xthal_read_background_map(entries: Pxthal_MPU_entry): int32; external;
{$endif}
