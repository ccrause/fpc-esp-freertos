...
function adc1_pad_get_io_num(channel: Tadc1_channel;
  gpio_num: Pgpio_num): Tesp_err; cdecl; external;

function adc1_config_width(width_bit: Tadc_bits_width): Tesp_err; cdecl; external;

function adc_set_data_width(adc_unit: Tadc_unit;
  width_bit: Tadc_bits_width): Tesp_err; cdecl; external;

function adc1_config_channel_atten(channel: Tadc1_channel;
  atten: Tadc_atten): Tesp_err; cdecl; external;

function adc1_get_raw(channel: Tadc1_channel): int32; cdecl; external;
...
function adc_set_data_inv(adc_unit: Tadc_unit; inv_en: longbool): Tesp_err; cdecl; external;

function adc_set_clk_div(clk_div: byte): Tesp_err; cdecl; external;

function adc_set_i2s_data_source(src: Tadc_i2s_source_t): Tesp_err; cdecl; external;
...
function adc2_get_raw(channel: Tadc2_channel; width_bit: Tadc_bits_width;
  raw_out: Pint32): Tesp_err; cdecl; external;

function adc2_vref_to_gpio(gpio: Tgpio_num): Tesp_err; cdecl; external;
