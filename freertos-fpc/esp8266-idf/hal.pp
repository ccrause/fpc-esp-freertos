...
procedure xthal_save_cpregs(base: pointer; para2: longint); external;
procedure xthal_restore_cpregs(base: pointer; para2: longint); external;
...
procedure xthal_init_mem_cp(para1: pointer; para2: longint); external;
procedure xthal_icache_region_invalidate(addr: pointer; size: dword); external;
procedure xthal_dcache_region_invalidate(addr: pointer; size: dword); external;
procedure xthal_icache_line_invalidate(addr: pointer); external;
procedure xthal_dcache_line_invalidate(addr: pointer); external;
procedure xthal_dcache_region_writeback(addr: pointer; size: dword); external;
procedure xthal_dcache_line_writeback(addr: pointer); external;
procedure xthal_dcache_region_writeback_inv(addr: pointer; size: dword); external;
...
function xthal_set_cache_prefetch(para1: longint): longint; external;
function xthal_get_cache_prefetch: longint; external;
function xthal_set_soft_break(addr: pointer): dword; external;
procedure xthal_remove_soft_break(addr: pointer; para2: dword); external;
function xthal_disassemble(instr_buf: Pbyte; tgt_addr: pointer; buffer: PChar;
  buflen: dword; options: dword): longint; external;
function xthal_disassemble_size(instr_buf: Pbyte): longint; external;
function xthal_memcpy(dst: pointer; src: pointer; len: dword): pointer; external;
function xthal_bcopy(src: pointer; dst: pointer; len: dword): pointer; external;
function xthal_compare_and_set(addr: Plongint; test_val: longint;
  compare_val: longint): longint; external;
procedure xthal_window_spill; external;
procedure xthal_validate_cp(para1: longint); external;
procedure xthal_invalidate_cp(para1: longint); external;
procedure xthal_set_cpenable(para1: dword); external;
function xthal_get_cpenable: dword; external;
function xthal_get_intenable: dword; external;
procedure xthal_set_intenable(para1: dword); external;
function xthal_get_interrupt: dword; external;
procedure xthal_set_intset(para1: dword); external;
procedure xthal_set_intclear(para1: dword); external;
function xthal_get_ccount: dword; external;
procedure xthal_set_ccompare(para1: longint; para2: dword); external;
function xthal_get_ccompare(para1: longint): dword; external;
function xthal_get_prid: dword; external;
function xthal_vpri_to_intlevel(vpri: dword): dword; external;
function xthal_intlevel_to_vpri(intlevel: dword): dword; external;
function xthal_int_enable(para1: dword): dword; external;
function xthal_int_disable(para1: dword): dword; external;
function xthal_set_int_vpri(intnum: longint; vpri: longint): longint; external;
function xthal_get_int_vpri(intnum: longint): longint; external;
procedure xthal_set_vpri_locklevel(intlevel: dword); external;
function xthal_get_vpri_locklevel: dword; external;
function xthal_set_vpri(vpri: dword): dword; external;
function xthal_get_vpri: dword; external;
function xthal_set_vpri_intlevel(intlevel: dword): dword; external;
function xthal_set_vpri_lock: dword; external;
function xthal_tram_pending_to_service: dword; external;
procedure xthal_tram_done(serviced_mask: dword); external;
function xthal_tram_set_sync(intnum: longint; sync: longint): longint; external;
function xthal_set_tram_trigger_func(trigger_fn: PXtHalVoidFunc): PXtHalVoidFunc;
  external;
function xthal_get_cacheattr: dword; external;
function xthal_get_icacheattr: dword; external;
function xthal_get_dcacheattr: dword; external;
procedure xthal_set_cacheattr(para1: dword); external;
procedure xthal_set_icacheattr(para1: dword); external;
procedure xthal_set_dcacheattr(para1: dword); external;
function xthal_set_region_attribute(addr: pointer; size: dword;
  cattr: dword; flags: dword): longint; external;
...
procedure xthal_icache_region_lock(addr: pointer; size: dword); external;
procedure xthal_dcache_region_lock(addr: pointer; size: dword); external;
...
procedure xthal_icache_region_unlock(addr: pointer; size: dword); external;
procedure xthal_dcache_region_unlock(addr: pointer; size: dword); external;
...
procedure xthal_memep_inject_error(addr: pointer; size: longint;
  flags: longint); external;
function xthal_static_v2p(vaddr: dword; paddrp: Pdword): longint; external;
...
function xthal_inst_type(addr: pointer): dword; external;
function xthal_branch_addr(addr: pointer): dword; external;
function xthal_get_npc(user_state: PXTHAL_STATE): dword; external;
{$endif}
