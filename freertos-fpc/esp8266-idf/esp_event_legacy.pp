...
uses
  esp_err, esp_wifi_types, esp_netif, esp_event_base, tcpip_adapter, portmacro;
...
function esp_event_loop_init(cb: Tsystem_event_cb; ctx: pointer): Tesp_err; external;

function esp_event_loop_set_cb(cb: Tsystem_event_cb; ctx: pointer): Tsystem_event_cb; external;
