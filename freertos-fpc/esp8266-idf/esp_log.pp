...
function esp_log_set_putchar(func: Tputchar_like_t): Tputchar_like_t; cdecl; external;
...
procedure esp_early_log_write(level: Tesp_log_level_t; tag: PChar; format: PChar); cdecl; varargs; external;
