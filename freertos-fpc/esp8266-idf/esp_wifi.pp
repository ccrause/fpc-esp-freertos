...
function esp_wifi_set_promiscuous_rx_cb(cb: Twifi_promiscuous_cb_t): Tesp_err;
  cdecl; external;
function esp_wifi_set_promiscuous(en: longbool): Tesp_err; cdecl; external;
function esp_wifi_get_promiscuous(en: Plongbool): Tesp_err; cdecl; external;
...
type
  Tesp_vendor_ie_cb_t = procedure(ctx: pointer; _type: Twifi_vendor_ie_type;
    sa: TMac; vnd_ie: Pvendor_ie_data_t; rssi: longint); cdecl;
...
procedure esp_wifi_set_max_tx_power_via_vdd33(vdd33: uint16); cdecl; external;
function esp_wifi_get_vdd33: uint16; cdecl; external;
function esp_wifi_get_max_tx_power(power: pbyte): Tesp_err; cdecl; external;
...
function esp_wifi_80211_tx(ifx: Twifi_interface; buffer: pointer;
  len: longint; en_sys_seq: longbool): Tesp_err; cdecl; external;
function esp_wifi_get_state: Twifi_state; cdecl; external;
