...
type
  Terr_t = int8;  // defined in lwip/err.h
  Tnetif = record end;
  Pnetif = ^Tnetif;
  ...
  Tesp_netif_netstack_lwip_vanilla_config = record
    init_fn: function(para1: Pnetif): Terr_t; cdecl;
    input_fn: procedure(netif: pointer; buffer: pointer; len: Tsize_t;
        eb: pointer); cdecl;
  end;
  ...
  Tesp_netif_netstack_lwip_ppp_config = record
    input_fn: procedure(netif: pointer; buffer: pointer; len: Tsize_t;
        eb: pointer); cdecl;
    ppp_events: Tesp_netif_ppp_config_t;
  end;
  ...
  Pesp_netif_t = ^Tesp_netif_obj;
  Pesp_netif_api_msg_t = ^Tesp_netif_api_msg_t;
  Tesp_netif_api_fn = function(msg: Pesp_netif_api_msg_t): int32;
  Tesp_netif_api_msg_t = record
    type_: int32;
    ret: int32;
  ...
  Tesp_netif_ip_lost_timer_t = Tesp_netif_ip_lost_timer_s;
  Pesp_netif_ip_lost_timer_t = ^Tesp_netif_ip_lost_timer_t;
  Tlwip_ppp_ctx_t = record end;
  Plwip_ppp_ctx_t = ^Tlwip_ppp_ctx_t;
